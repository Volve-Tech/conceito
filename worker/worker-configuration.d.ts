/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=worker/wrangler.jsonc worker/worker-configuration.d.ts` (hash: a7daabe2c7943fb4fbba7c44ef9676b5)
// Runtime types generated with workerd@1.20260910.1 2026-09-10 nodejs_compat
interface __BaseEnv_Env {
	EMAIL: SendEmail;
	ALLOWED_ORIGINS: "https://volve-tech.github.io,https://conceitocontabilidade.com.br,http://localhost:4321,http://127.0.0.1:4321";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGINS" | "RECAPTCHA_SECRET_KEY" | "CONTACT_EMAIL" | "CONTACT_FROM">> {}
}
